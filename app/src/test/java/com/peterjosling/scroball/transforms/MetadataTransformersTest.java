...
public class MetadataTransformersTest {
  ...
  public void transformForPackageName_youtube() {
    ...
    Track input1 =
        Track.builder().track("     Some Artist  -  Track (with details) ").artist("").build();
    Track output1 = Track.builder().track("Track (with details)").artist("Some Artist").build();
    ...
    Track input2 =
        Track.builder()
            ...
            .artist("")
            .build();
    Track output2 = Track.builder().track("Something Music").artist("Another Artist").build();
